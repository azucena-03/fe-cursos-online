...
export default function PaginadorCurso() {
  const [textBusquedaCurso, setTextBusquedaCurso] = useState("");
  const typingBuscadorTexto = ControlTyping(textBusquedaCurso, 900);
      ...
      <Grid container style={{ paddingTop: "20px", paddingBottom: "20px" }}>
        <Grid item xs={12} sm={4} md={6}>
          <TextField
            ...
            variant="outlined"
            label="Busca Curso"
            onChange={(e) => setTextBusquedaCurso(e.target.value)}
          />
        </Grid>
      </Grid>
